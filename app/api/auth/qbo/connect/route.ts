...
export async function GET() {
  ...
  authorizationUrl.searchParams.append("client_id", process.env.QBO_CLIENT_ID!);
  authorizationUrl.searchParams.append("response_type", "code");
  authorizationUrl.searchParams.append("scope", "com.intuit.quickbooks.accounting");
  authorizationUrl.searchParams.append("redirect_uri", process.env.QBO_REDIRECT_URI!);
